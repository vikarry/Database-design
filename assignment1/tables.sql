...
INSERT INTO movies(movid, title, country, duration, releasedate, description)
VALUES (1001, 'Casablanca', 'United States', 102, DATE '1942-11-26', '')
...
INSERT INTO releaselanguages(movid, language)
VALUES (1001, 'English')
     , (1001, 'French')
     , (1001, 'German')
     , (1001, 'Italian')
...
INSERT INTO moviegenres(movid, genre)
VALUES (1001, 'Drama')
     , (1002, 'Romance')
     , (1002, 'War')
     , (1002, 'Adventure')
...
INSERT INTO users(userid, uname, email, dateofbirth)
VALUES ('jack23ss', 'Jack Kessler', 'kjack@movieinfo.com', DATE '1982-04-22')
...
INSERT INTO review(userid, movid, reviewdate, rating, reviewtxt)
VALUES ('jack23ss', 1001, DATE '2018-03-22', 7, '')
